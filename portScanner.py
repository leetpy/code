...
def get_paras():
    try:
        ...
        opt.add_option('--host',
                       dest='host',
                       type='str',
                       help='scan host address')
        opt.add_option('-s', '--start_port',
                       dest='start_port',
                       default=1,
                       type='int',
                       help='start port')
        opt.add_option('-e', '--end_port',
                       dest='end_port',
                       type='int',
                       default=65535,
                       help='end port')
        opt.add_option('-n', '--threads',
                       dest='threads',
                       type='int',
                       default=1,
                       help='threads')
...
def service(port):
    service_list = {
            ...
            3:'compressnet', 4:'sfs', 5:'rje', 
            7:'echo', 
            8:'trojan - Ping Attack',
            9:'discard', 11:'systat', 13:'daytime', 
            15:'netstat / trojan[B2]', 17:'quotd', 
            18:'msp', 19:'chargen',
            20:'ftp-data', 21:'ftp', 22:'ssh', 23:'telnet', 
            24:"priv-mail / trojan[BO2K]", 25:'smtp', 
            26:'rsftp', 27:'nsw-fe',
            28:'trojan[amanda]', 29:'msg-icp', 
            30:'trojan[Agent 40421]', 40421:'trojan[Agent 40421]', 
            31:'msg-auth',
            33:'dsp[Display Support Protocol]',
            34:'remote[Remote File]', 35:'priv-printer',
            37:'time', 38:'rap[Resource Location Protocol]',
            41:'graphics', 42:'nameserver', 43:'whois', 
            44:'mpm-flags', 45:'mpm', 46:'mpm-snd', 
            47:'ni-ftp', 48:'auditd',
            49:'bbn-login', 50:'re-mail.ck', 51:'la-maint',
            52:'xns-time', 53:'domain', 54:'xns-ch', 
            55:'isi-gl',
            56:'xns-auth', 57:'priv-terminal / MTP', 
            58:'xns-mail', 59:'priv-file / Backdoor.Sdbot.AJ', 
            61:'NI MAIL', 62:'ACA Services',
            63:'whois++', 64:'covia', 65:'tacacs-ds',
            66:'Oracle Sql *NET', 67:'bootps',
            68:'bootpc', 69:'tftp', 70:'gopher',
            71:'netrjs-1', 72:'netrjs-2',
            73:'netrjs-3', 74:'netrjs-4', 75:'priv-dial',
            76:'deos', 77:'priv-RJE', 78:'vettcp',
            79:'finger', 80:'http', 81:'hosts2-ns', 82:'xfer',
            83:'mit-ml-dev', 84:'Common Trace Facility',
            85:'mit-ml-dev',
            86:'mfcobol', 87:'priv-terminal link', 88:'kerberos',
            89:'su-mit-tg', 90:'dnsix', 91:'mit-dov', 92:'Network printing protocol',
            93:'device control protocol', 94:'objcall',
            95:'supdup', 96:'dixie', 97:'swift-rvf', 98:'tacnews', 99:'metagram',
            100:'newacct', 101:'hostname', 102:'iso-tsap',
            103:'gppitnp', 104:'acr-nema', 105:'csnet-ns', 106:'3com-tsmux',
            107:'rtelnet', 108:'SNA gateway',  109:'pop2', 110:'pop3', 111:'sunrpc',
            112:'mcidas', 113:'auth', 114:'audionews',
            115:'sftp', 116:'ansanotify', 117:'uucp-path', 118:'sqlserv',
            119:'nntp', 120:'cfdptkt', 121:'erpc', 122:'smakynet',
            123:'ntp', 124:'ansatrader', 125:'locus-map',
            126:'unitary', 127:'locus-con', 128:'gss-xlicen', 129:'pwdgen',
            130:'cisco-fna', 131:'cisco-tna', 132:'cisco-sys',
            133:'statsrv', 134:'ingres-net', 135:'loc-srv', 136:'profile',
            137:'netbios-ns', 138:'netbios-dgm', 139:'netbios-ssn',  140:'emfis-data', 
            141:'emfis-cntl', 142:'bl-idm', 143:'imap2',
            144:'news', 145:'uaac', 146:'iso-tp0', 147:'iso-ip', 148:'cronus', 
            149:'aed-512', 150:'SQL-NET', 151:'hems',
            152:'bftp', 153:'sgmp', 154:'netsc-prod', 155:'netsc-dev',
            156:'SQL servic', 157:'knet-cmp', 158:'pcmail-srv', 159:'nss-routing',
            160:'sgmp-traps', 161:'snmp', 162:'snmptrap', 163:'cmip-man', 
            164:'cmip-agent', 165:'xns-courier', 166:'s-net',
            167:'namp', 168:'rsvd', 169:'send', 171:'multiplex', 170:'print-srv', 
            172:'cl/1', 173:'xyplex-mux', 174:'mailq',
            175:'vmnet',  176:'genrad-mux', 177:'xdmcp', 178:'nextstep', 
            179:'bgp', 180:'ris', 181:'unify', 182:'audit SITP',
            183:'ocbinder', 184:'ocserver', 185:'remote-kis', 186:'KIS protocol', 
            ...
            448:'ddm-byte', 449:'as-servermap',  450:'tserver', 451:'sfs-smp-net', 452:'sfs-config',
            453:'creativeserver',
            454:'contentserver', 455:'creativepartnr', 456:'macon-tcp', 
            457:'scohelp', 458:'appleqtc', 460:'skronk',
            459:'ampr-rcmd', 461:'datasurfsrv', 462:'datasurfsrvsec', 463:'alpes', 
            464:'kpasswd', 465:'ssmtp', 466:'digital-vrc',
            467:'mylex-mapd', 468:'photuris', 469:'rcp', 470:'scx-proxy', 
            471:'mondex', 472:'ljk-login', 473:'hybrid-pop',
            474:'tn-tl-w1', 475:'tcpnethaspsrv', 512:'exec', 513:'login', 514:'cmd', 
            515:'printer', 517:'talk', 518:'ntalk',
            ...
            748:'ris-cm', 749:'kerberos-adm',
            750:'rfile', 751:'pump', 752:'qrh', 753:'rrh', 754:'tell', 758:'nlogin',
            ...
            999:'garcon / puprouter', 1000:'cadlock',1:'tcpmux',1:'tcpmux',2:'compressnet',
            3:'compressnet',5:'rje',7:'echo',9:'discard',
...
if __name__ == "__main__":
    options = get_paras()
    try:
        with futures.ThreadPoolExecutor(options.threads) as executor:
            fs = [executor.submit(check_port, options.host, n)
                  for n in range(options.start_port, options.end_port+1)]
            futures.wait(fs)
    except KeyboardInterrupt:
        print "\nCTRL^C Pressed, quitting the progra.."
        exit()
